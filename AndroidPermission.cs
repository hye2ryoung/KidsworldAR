...
public class AndroidPermission : AndroidJavaProxy
{
    ...
    public AndroidPermission(Action<string> onGrantedCallback, Action<string> onDeniedCallback, Action<string> onDeniedAndDontAskAgainCallback)
...
public class AndroidPermissionsManager
{
    ...
    public static void RequestPermission(string permissionName, AndroidPermission callback)
    {
        RequestPermission(new[] { permissionName }, callback);
    }

    public static void RequestPermission(string[] permissionNames, AndroidPermission callback)
    {
